...
public class MinimizeWindow {
    ...
    private static MinimizeWindow instance;
    ...
    static{
        ...
        URL url = MinimizeWindow.class.getResource("../../../img/find.png");
    ...
    public static MinimizeWindow getInstance(){
        if(instance == null){
            instance = new MinimizeWindow();
        }
        return instance;
    }
    ...
    private MinimizeWindow(){
        try {
            ...
            if (!SystemTray.isSupported()) {
                //系统托盘不支持
                //logger.info(Thread.currentThread().getStackTrace()[ 1 ].getClassName() + ":系统添加失败");
            ...
            //鼠标移到系统托盘,会显示提示文本
            trayIcon.setToolTip("MyIntrerst");
            tray.add(trayIcon);
        } catch (Exception e) {
            //系统托盘添加失败
